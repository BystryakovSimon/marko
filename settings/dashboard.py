    ...
    def __init__(self, **kwargs):
        ...
        self.children.append(
            modules.ModelList(
                title = u'Галереи',
                models=(
                    'gallerymixers.models.GalleryMixer',
                    'gallerycountertops.models.GalleryCountertops',
                    'gallerysink.models.GallerySink',
                    'gallerycolors.models.GalleryColors',
        ...
        self.children.append(
            modules.ModelList(
                title = u'Формы',
                models=(
                    'form_designer.models.FormLog',
                    'form_designer.models.FormDefinition',
                ),
            )
        )
